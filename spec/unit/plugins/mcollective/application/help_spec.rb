...
module MCollective
    describe "help application" do
        before do
            application_file = File.join([File.dirname(__FILE__), "../../../../../plugins/mcollective/application/help.rb"])
            @util = MCollective::Test::ApplicationTest.new("help", :application_file => application_file)
            @app = @util.plugin
        end
